                        ...
                        InkWell(
                          ...
                          child: SizedBox(
                            ...
                            child: ElevatedButton(
                              onPressed: () async {
                              var url =
                                 Uri.parse("https://www.google.com/maps/dir//water+blaster/data=!4m6!4m5!1m1!4e2!1m2!1m1!1s0x2e708d368c2bab47:0x7cb65896fa025470?sa=X&ved=2ahUKEwj8iPLQ2Zr4AhWEUGwGHa2CALMQ9Rd6BAhxEAQ");
                          ...
                          child: SizedBox(
                            ...
                            child: ElevatedButton(
                              onPressed: () async {
                              var url =
                                 Uri.parse("https://wisatakaka.com/harga-tiket-masuk-water-blaster-semarang/");
                              if (await canLaunchUrl(url)) {
                                await launchUrl(url);
                              } else {
                                // can't launch url
