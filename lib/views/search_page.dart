...
class SearchPage extends SearchDelegate {
  final CollectionReference _firebaseFirestore = FirebaseFirestore.instance.collection('destinations');
   SearchPage() : super(
            ...
            const EdgeInsets.symmetric(horizontal: 16.0, vertical: 8.0),
                    onTap: (){
                      Navigator.pushNamed(
                                    ...
                                    arguments: DestinationDetail(name: data['name'], description: data['description'], location: data['location'], price: data['price'].toString(), rating: data['rating'].toString(), urlImage: data['urlImage']));
                    },
